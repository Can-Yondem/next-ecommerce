        ...
        <div className="">
            <form className="flex flex-col justify-center items-center gap-6 bg-white sm:w-[475px] w-[350px] rounded-b-xl mx-auto">
                ...
                <div className="flex gap-6 mb-5">
                    ...
                    <button className="border-2 rounded-full p-3 border-blue-400 bg-blue-400 text-white"><AiOutlineTwitter /></button>
                    <button className="border-2 rounded-full p-3 border-blue-600 bg-blue-600 text-white"><ImFacebook /></button>
                </div>
