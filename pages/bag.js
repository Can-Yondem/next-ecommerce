  ...
  return (
    <div className="h-almost">
      ...
      <div className="container mx-auto flex justify-end">
        ...
        <button className="flex items-center gap-3 ml-10 px-10 text-white font-semibold bg-primary-color hover:bg-yellow-700 p-2 rounded-md mt-4 transition ease-out duration-300 ">
          Satın Al
        </button>
      </div>
    </div>
